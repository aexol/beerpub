...
export type ValueTypes = {
	...
	beers?:ValueTypes["Beer"],
		__typename?: true
}>;
	["Query"]: AliasType<{
	clientQuery?:ValueTypes["ClientQuery"],
	pubQuery?:ValueTypes["PubQuery"],
		__typename?: true
}>;
	["Order"]: AliasType<{
	number?:true,
	createdAt?:true,
	orderedBeers?:ValueTypes["OrderedBeer"],
		__typename?: true
}>;
	["OrderedBeer"]: AliasType<{
	quantity?:true,
	beer?:ValueTypes["Beer"],
		__typename?: true
}>;
	["PubQuery"]: AliasType<{
	...
	["PubMutation"]: AliasType<{
submitOrder?: [{	order:ValueTypes["SubmitOrder"]},true],
addBeer?: [{	beer:ValueTypes["AddBeer"]},true],
editBeer?: [{	editBeer:ValueTypes["EditBeer"],	SKUInput:ValueTypes["SKUInput"]},true],
removeBeer?: [{	SKUInput:ValueTypes["SKUInput"]},true],
cancelOrder?: [{	orderDetail:ValueTypes["OrderDetail"]},true],
		__typename?: true
}>;
	["AddBeer"]: {
	name:string,
	...
	["SubmitOrder"]: {
	productInOrder:ValueTypes["ProductInOrder"][]
};
	["ProductInOrder"]: {
	SKU:string,
	quantity:number
	...
	["Mutation"]: AliasType<{
	pubMutation?:ValueTypes["PubMutation"],
		__typename?: true
}>
  }
...
export type ModelTypes = {
	...
	["ClientQuery"]: {
		beers:ModelTypes["Beer"][]
};
	["Query"]: {
		clientQuery:ModelTypes["ClientQuery"],
	pubQuery:ModelTypes["PubQuery"]
};
	["Order"]: {
		number:number,
	createdAt:string,
	orderedBeers:ModelTypes["OrderedBeer"][]
};
	["OrderedBeer"]: {
		quantity:number,
	beer:ModelTypes["Beer"]
};
	["PubQuery"]: {
	...
	["AddBeer"]: GraphQLTypes["AddBeer"];
	["EditBeer"]: GraphQLTypes["EditBeer"];
	["SKUInput"]: GraphQLTypes["SKUInput"];
	["SubmitOrder"]: GraphQLTypes["SubmitOrder"];
	["ProductInOrder"]: GraphQLTypes["ProductInOrder"];
	["OrderDetail"]: GraphQLTypes["OrderDetail"];
	["Mutation"]: {
		pubMutation?:ModelTypes["PubMutation"]
}
    }
...
export type GraphQLTypes = {
	...
	beers: Array<GraphQLTypes["Beer"]>
};
	["Query"]: {
	__typename: "Query",
	clientQuery: GraphQLTypes["ClientQuery"],
	pubQuery: GraphQLTypes["PubQuery"]
};
	["Order"]: {
	__typename: "Order",
	number: number,
	createdAt: string,
	orderedBeers: Array<GraphQLTypes["OrderedBeer"]>
};
	["OrderedBeer"]: {
	__typename: "OrderedBeer",
	quantity: number,
	beer: GraphQLTypes["Beer"]
};
	["PubQuery"]: {
	__typename: "PubQuery",
	...
	["SubmitOrder"]: {
		productInOrder: Array<GraphQLTypes["ProductInOrder"]>
};
	["ProductInOrder"]: {
		SKU: string,
	quantity: number
	...
	["Mutation"]: {
	__typename: "Mutation",
	pubMutation?: GraphQLTypes["PubMutation"]
}
    }
